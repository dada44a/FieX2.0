...
export const Route = createLazyFileRoute('/protected/admin/add')({
...
export default function RouteComponent() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      {/* Error message */}
      {postData.error && (
        <div className="mb-4 p-3 bg-red-100 text-red-700 rounded">{postData.error.message}</div>
      )}

      {/* Success message */}
      {postData.isSuccess && (
        <div className="mb-4 p-3 bg-green-100 text-green-700 rounded">{`Movie "${JSON.stringify(postData.data)}" added successfully!`}</div>
      )}
      ...
      >
        ...
        <Button type="submit" disabled={postData.isPending}>
          {postData.isPending ? "Saving..." : "Save Movie"}
        </Button>
